  ...
  return (
    <nav className="bg-red-600 text-white px-4 py-3 flex justify-between items-center shadow-md">
      ...
      <div className="hidden md:flex gap-6">
        <button onClick={()=>handleClick("home")} className="hover:text-gray-200 transition">Home</button>
        <button onClick={()=>handleClick("kalender")} className="hover:text-gray-200 transition">Kalender</button>
